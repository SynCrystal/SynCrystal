function [kb,kk1,kk2] = SS_ct2_polar_v1(num_direction,fff,SPg,NB,rad,is_real,R_low,R_high,epsl,red,t_sc, s_sc,is_cos,  wedge_length_coarse)
...
%   size(kb) = NB,
%
% kk1: information function in the first direction
% kk2: information function in the second direction
%
%by Haizhao Yang
