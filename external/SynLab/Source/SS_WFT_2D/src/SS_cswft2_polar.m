function [kb avgdx avgdy kk1 kk2] = SS_cswft2_polar(num_direction,fff,h,NB,sigma,R_low,R_high,epsl)
%Input:
%   fff is the image
...
if(1)
    ...
    avgdx = zeros(NB(1)+1,NB(2)+1,szc(2),szc(3));
    avgdy = zeros(NB(1)+1,NB(2)+1,szc(2),szc(3));
